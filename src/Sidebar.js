        ...
        <li className="nav-item">
            ...
            <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div className="bg-white py-2 collapse-inner rounded">
                    ...
                    <a className="collapse-item"  onClick={() => navigate("/create-user")}>Create user</a>
                    <a className="collapse-item"  onClick={() => navigate("/users")}>List users</a>
                </div>
            </div>
        </li>
        ...
        <li className="nav-item">
            ...
            <div id="collapseTeacher" className="collapse" aria-labelledby="headingUtilities"
                ...
                <div className="bg-white py-2 collapse-inner rounded">
                    ...
                    <a className="collapse-item"  onClick={() => navigate("/create-profile")}>Create Profile</a>
                    <a className="collapse-item"  onClick={() => navigate("/list-user-profile")}>List users Profile</a>
                </div>
            </div>
        </li>
